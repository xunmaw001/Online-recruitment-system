...
var centerMenu = [
    ...
    ,{
        name: '面试经验收藏',
        url: '../miansjingyanCollection/list.html'
    }
    ,{
        name: '职位收藏',
...
var indexNav = [
    ...
    {
        name: '面试经验',
        url: './pages/miansjingyan/list.html'
    },
    {
        name: '公告信息',
...
var adminurl =  "http://localhost:8080/wangshangzaopinh/admin/dist/index.html#/login";
